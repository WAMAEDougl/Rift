...
export const metadata: Metadata = {
  title: "Privacy Policy | Ayola Foods KE",
};

export default function PrivacyPolicy() {
  return (
    <div className="pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray prose-headings:text-earth">
        <h1>Privacy Policy</h1>
        <p className="text-sm text-muted-foreground/60">Last updated: March 2026</p>

        <h2>1. Who We Are</h2>
        <p>Ayola Foods Limited (&ldquo;Ayola Foods&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) operates ayola-foods-ke.vercel.app and the Ayola Foods restaurant at Ruhan Plaza, Kahawa Sukari, Nairobi. Contact: ayola.foods.kenya@gmail.com, 0713 280 550.</p>
        ...
        <p>To exercise these rights, contact ayola.foods.kenya@gmail.com.</p>
        ...
        <h2>9. Contact</h2>
        <p>For privacy inquiries: ayola.foods.kenya@gmail.com or <Link href="/contact" className="text-primary">contact us</Link>.</p>
      </div>
    </div>
  );
}
