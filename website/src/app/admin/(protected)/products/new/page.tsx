    ...
    <div className="space-y-6 mb-16">
      ...
      <form id="new-product-form" onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <aside className="lg:col-span-4 space-y-5">
          ...
          {/* Image */}
          <SectionCard icon={<ImageIcon size={17} />} title="Product Image" subtitle="URL of the product photo">
            <div className="space-y-3">
              <div className="aspect-square rounded-xl bg-gray-50 border border-gray-100 overflow-hidden flex items-center justify-center">
                {imageUrl ? (
