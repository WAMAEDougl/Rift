  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        <h2 className="text-sm font-medium text-gray-700 mb-3">Danger Zone</h2>
        <button
          type="button"
          onClick={() => setDeleteOpen(true)}
          className="border border-red-300 text-red-600 hover:bg-red-50 rounded-md px-4 py-2 text-sm font-medium"
        >
          Delete Product
        </button>
      </div>
