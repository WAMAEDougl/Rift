...
export const metadata: Metadata = {
  title: "Terms of Service | Ayola Foods KE",
};
  ...
  return (
    <div className="pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray prose-headings:text-earth">
        ...
        <h2>10. Contact</h2>
        <p>Questions about these terms? Contact us at ayola.foods.kenya@gmail.com or <Link href="/contact" className="text-primary">visit our contact page</Link>.</p>
      </div>
    </div>
  );
}
