...
export const metadata: Metadata = {
  title: "Return & Refund Policy | Ayola Foods KE",
};
  ...
  return (
    <div className="pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray prose-headings:text-earth">
        ...
        <h2>Contact</h2>
        <p>For returns and refunds: WhatsApp 0713 280 550 or email ayola.foods.kenya@gmail.com. <Link href="/contact" className="text-primary">Contact page</Link>.</p>
      </div>
    </div>
  );
}
