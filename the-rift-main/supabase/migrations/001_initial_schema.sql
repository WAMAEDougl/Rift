-- Rift & Root: Phase 0 - Initial Schema
-- Categories, Products, Profiles, Orders with RLS
...
CREATE TABLE IF NOT EXISTS public.store_settings (
  ...
  store_name text NOT NULL DEFAULT 'Rift & Root Kenya',
  support_email text,
  support_phone text,
  default_delivery_fee integer NOT NULL DEFAULT 200,
...
-- Orders: own read, guest insert, admin all
