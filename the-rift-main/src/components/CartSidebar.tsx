            ...
            {items.length > 0 && (
              <div className="border-t border-border p-5 space-y-4">
                ...
                <Link
                  href="/checkout"
                  onClick={() => setIsCartOpen(false)}
                  className="block w-full bg-primary text-primary-foreground text-center py-3.5 rounded-xl font-bold hover:opacity-90 transition-all shadow-lg shadow-soft active:scale-[0.98]"
                >
