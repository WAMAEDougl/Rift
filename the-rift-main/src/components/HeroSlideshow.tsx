...
export default function HeroSlideshow({
  ...
  return (
    ...
    >
      {/* Slides — only render once ready to avoid fallback→DB flash */}
      <div
      ...
      {/* Per-slide text — homepage only, DB banners only, fade in with slides */}
      ...
      {/* Dot indicators — only show when ready */}
